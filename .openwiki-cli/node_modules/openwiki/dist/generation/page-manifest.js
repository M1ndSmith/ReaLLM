 ...
 */
export async function replaceRepositoryPageManifest(root, pages, source, preservePages = new Set(), preserveSourcePages = new Set()) {
    ...
    for (const page of pages) {
        ...
        if (preserveSourcePages.has(canonicalPage)) {
            ...
            if (previousEntry) {
                const refreshedEntry = await buildManifestEntry(root, canonicalPage, {
                    ...
                    ...(previousEntry.sourceFingerprint
                        ...
                        : {}),
                }, previousEntry.completedBy, previousEntry.completedRunId);
            ...
            try {
                next.pages[canonicalPage] = await buildManifestEntry(root, canonicalPage, source);
            }
            catch (error) {
                if (error instanceof RepositoryRunError)
                    continue;
