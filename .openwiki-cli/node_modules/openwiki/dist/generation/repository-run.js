...
export async function finishRepositoryRun(run, options = {}) {
    ...
    const preserveSourcePages = new Set(currentPages
        .map((page) => normalizeWikiPagePath(page))
        .filter((page) => !regeneratedPages.has(page) && !skippedPages.has(page)));
    await replaceRepositoryPageManifest(run.root, currentPages, getRepositoryRunSourceCheckpoint(run.state), skippedPages, preserveSourcePages);
