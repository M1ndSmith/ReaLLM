...
export declare const HOST_TARGETS: {
    readonly bob: {
        ...
        readonly documentationUrl: "https://bob.ibm.com/docs/ide/configuration/mcp/understanding-mcp";
    };
    readonly codex: {
        readonly id: "codex";
    ...
    readonly kiro: {
        ...
        readonly producerActor: "kiro";
        readonly user: {
            readonly skillDirectory: ".kiro/skills/openwiki";
            readonly mcpConfig: {
                readonly kind: "json";
                readonly relativePath: ".kiro/settings/mcp.json";
            };
        };
        readonly project: {
            readonly skillDirectory: ".kiro/skills/openwiki";
        ...
        readonly documentationUrl: "https://kiro.dev/docs/mcp/configuration/";
    };
};
/**
